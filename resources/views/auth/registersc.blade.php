    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card login-wrap">
                <div class="card-header"><h2 class="form-signin-heading"><strong>- {{ __('Register') }} Service Center -</strong></h2></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('servicecenterregister') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="ph" class="col-md-4 col-form-label text-md-right">{{ __('Contact Number') }}</label>

                            <div class="col-md-6">
                                <input id="ph" type="text" class="form-control @error('ph') is-invalid @enderror" name="ph" value="{{ old('ph') }}" required autocomplete="ph" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="addr" name="addr" class="form-control @error('addr') is-invalid @enderror"  required autocomplete="addr" autofocus>{{ old('addr') }}</textarea>
