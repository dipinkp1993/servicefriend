              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                          ...
                          <span class="username">{{ Auth::guard('wholesaler')->user()->wholesalername }} </span>
                          <b class="caret"></b>
                      </a>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="/wholesaler/partrequests">Requests Service Center</a></li>
                          <li><a  href="/wholesaler/managepart">Manage Part</a></li>
                          <li><a  href="/wholesaler/viewparts">View Part</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="/wholesaler/managestock">Manage stocks</a></li>
                          <li><a  href="/wholesaler/viewstocks">View Stocks</a></li>
                      </ul>
                  </li>
                   <li class="sub-menu">
                      <a href="/wholesaler/changepassword">
                          <i class="fa fa-key"></i>
