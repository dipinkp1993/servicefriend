              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                          ...
                          <span class="username">{{ Auth::guard('servicecenter')->user()->centername }} </span>
                          <b class="caret"></b>
                      </a>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="/servicecenter/userrequests">View Service Requests</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="/servicecenter/userspartrequests">Request From Users</a></li>
                          <li><a  href="/servicecenter/partrequesttoadmin">Request  Parts To Whoesaler</a></li>
                          <li><a  href="/servicecenter/partrequesttoadminhistory">Parts Order History</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="/servicecenter/changepassword">
                          <i class="fa fa-key"></i>
